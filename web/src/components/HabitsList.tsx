...
export function HabitsList({ date, onCompletedChanged }: HabitsListProps) {
    ...
    // habitsInfo?.completedHabits -> Caso o valor não esteja nulo, evita erro de nulidade
    // habitsInfo!.completedHabits -> Força o React dizendo que o valor está preenchido
    ...
    return (
        <div className='mt-6 flex flex-col gap-3'>
            {habitsInfo?.possibleHabits.map(habit => {
                ...
                className='flex items-center gap-3 group focus:outline-none hover:outline-none disabled:cursor-not-allowed'
